  ...
  return (
    <>
      ...
      <div className="mb-5 flex items-center gap-3">
        ...
        <span className="text-[14px] font-600 text-ink-400">{tl("or_phone")}</span>
        <span className="h-px flex-1 bg-ink-200 dark:bg-ink-700" />
      </div>
      ...
      <button
        ...
        onClick={onContinue}
        className="flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-accent-500 text-[15px] font-700 text-[#4A2C00] transition-colors hover:bg-accent-600 disabled:opacity-40"
      >
