        ...
        {step === "login" && (
          <>
            ...
            <button
              ...
              className="flex h-12 w-full items-center justify-center gap-2 rounded-[14px] bg-amber-500 text-[14px] font-bold text-[#4A2C00] transition-colors hover:bg-amber-600 disabled:opacity-40"
            >
        ...
        {step === "tg-forgot" && tgDeepLink && (
          <div className="text-center">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex h-12 w-full items-center justify-center gap-2.5 rounded-[14px] bg-[#0088cc] text-[14px] font-bold text-white transition-opacity hover:opacity-90"
            >
