    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <select
          ...
          className="flex h-11 w-full rounded-xl border-[1.5px] border-gray-300 bg-white px-4 text-body font-semibold text-gray-900 outline-none focus:border-teal-500"
        >
