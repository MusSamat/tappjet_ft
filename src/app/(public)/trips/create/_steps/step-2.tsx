...
export function Step2({
  ...
  return (
    <div className="flex flex-col gap-4">
      <h2 className="text-[17px] font-bold text-ink-900">{t("step2_title")}</h2>

      <div className="rounded-2xl border border-ink-100 bg-white p-5">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-[15px] font-bold text-ink-900">{t("seats_title")}</div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="min-w-[28px] text-center text-[26px] font-extrabold text-ink-900">
              {seatsTotal}
            </span>
            <button
              type="button"
      ...
      <div className="rounded-2xl border border-ink-100 bg-white p-5">
        <div className="mb-3">
          <div className="text-[10px] font-bold uppercase tracking-widest text-ink-400">{t("price_label")}</div>
          <div className="mt-2 flex items-center gap-2">
            <input
              ...
              className="h-12 w-32 rounded-2xl border-2 border-ink-200 bg-ink-50 px-4 text-center text-[22px] font-extrabold text-ink-900 outline-none focus:border-brand-500"
            />
            <span className="text-[17px] font-bold text-ink-500">{t("price_som")}</span>
          </div>
        </div>
        <label className="flex cursor-pointer items-center gap-2">
          ...
          />
          <span className="text-[13px] font-semibold text-ink-700">{t("price_negotiable")}</span>
        </label>
      </div>

      <div className="rounded-2xl border border-ink-100 bg-white p-5">
        <p className="mb-3 text-[10px] font-bold uppercase tracking-widest text-ink-400">{t("luggage_section")}</p>
