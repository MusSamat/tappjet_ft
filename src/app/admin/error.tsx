...
export default function AdminError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-5 py-12 text-center">
      <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-danger-50">
        <AlertTriangle className="h-7 w-7 text-danger-500" aria-hidden="true" />
      </div>
      <h1 className="text-[20px] font-disp font-extrabold text-ink-900">Ошибка</h1>
      ...
      <Button variant="danger" size="md" onClick={reset} className="mt-6">
