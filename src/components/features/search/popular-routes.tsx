      ...
      <div className="flex flex-wrap gap-2">
        {routes.map((r) => (
          <Link
            ...
            className="flex items-center gap-1.5 rounded-xl border border-ink-200 bg-white px-3.5 py-2.5 text-[16px] font-bold text-ink-700 transition-colors hover:border-brand-400 hover:bg-brand-50 hover:text-brand-700 dark:border-ink-800 dark:bg-ink-900 dark:text-ink-300"
          >
            <span>{r.from}</span>
